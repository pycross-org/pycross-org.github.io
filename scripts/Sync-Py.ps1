...
# ? Install the `pycross_github_io_tools` Python module
...
$Comps = pycross_github_io_tools compile
...
if (!$NoPostSync) {
    ...
    pycross_github_io_tools 'sync-local-dev-configs'
